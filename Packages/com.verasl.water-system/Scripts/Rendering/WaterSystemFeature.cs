    ...
    public class WaterSystemFeature : ScriptableRendererFeature
    {
        ...
        class WaterFxPass : ScriptableRenderPass
        {
            ...
            public override void Configure(CommandBuffer cmd, RenderTextureDescriptor cameraTextureDescriptor)
            {
                ...
                // Update RTHandle usage
                RTHandles.SetReferenceSize(cameraTextureDescriptor.width, cameraTextureDescriptor.height);
                m_WaterFX.rt.Release();
                m_WaterFX = RTHandles.Alloc(cameraTextureDescriptor);
            ...
            {
                // Release the RTHandle when done
                if (m_WaterFX != null)
                {
                    m_WaterFX.Release();
                }
