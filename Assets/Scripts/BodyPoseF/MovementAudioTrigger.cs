...
namespace BodyPoseF
{
    ...
    public class MovementAudioTrigger : MonoBehaviour
    {
        ...
        {
            // Check if audio source and clips are available
            if (_audioSource == null || _audioClips == null || _audioClips.Length == 0)
            {
                Debug.LogWarning("Cannot play audio: missing audio source or clips");
                return;
            }
            ...
            AudioClip clipToPlay = RandomClipWithoutRepeat();
            if (clipToPlay != null)
            {
        ...
        private AudioClip RandomClipWithoutRepeat()
        {
            ...
            {
                Debug.LogWarning("No audio clips assigned to MovementAudioTrigger");
                return null;
            }
